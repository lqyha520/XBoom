...
class Article(SQLModel, table=True):
    ...
    target_account_id: Optional[str] = Field(default=None, index=True)
    created_at: datetime = Field(default_factory=datetime.now)
    updated_at: datetime = Field(default_factory=datetime.now)
...
class ScheduledTask(SQLModel, table=True):
    ...
    repeat_mode: str = Field(default="interval")
    ...
    target_appid: Optional[str] = Field(default=None, index=True)
    target_account_id: Optional[str] = Field(default=None, index=True)
    account_binding_mode: str = Field(default="default", index=True)
    preflight_status: str = Field(default="unchecked")
    preflight_message: Optional[str] = Field(default=None)
    preflight_checked_at: Optional[datetime] = Field(default=None)
    post_action: str = Field(default="publish")
